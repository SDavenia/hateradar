### Post duplicati 
Tra i 66 post, ce ne sono 7 che sono duplicati: 

```['1stbjop', '1stbiqy', '1stbjop', '1stbiqy', '1sncsim', '1stbjop', '1stbiqy']```

Sono lo stesso post, nello stesso subreddit, ma proveniente da file di due date diverse. 
Non ho ben capito il processo di questa cosa 
